package com.app.bkndbydips2.integrationtest;
...
import com.app.bkndbydips2.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("bkndbydips2", n.getAttribute("Namespace"));
  ...
  void  testCreateOrganizationInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips2/Organizations")
        .then()
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips2/Organizations?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/bkndbydips2/Organizations/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmployeePersonalInfoInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips2/EmployeePersonalInfoes")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips2/EmployeePersonalInfoes?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips2/EmployeePersonalInfoes/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreateEmlpoyeeProfileInstance() throws IOException {
    given()
        ...
        .when()
        .post("/bkndbydips2/EmlpoyeeProfiles")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/bkndbydips2/EmlpoyeeProfiles?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/bkndbydips2/EmlpoyeeProfiles/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM bkndbydips2.Organization");
    jdbcTemplate.execute("DELETE FROM bkndbydips2.EmployeePersonalInfo");
    jdbcTemplate.execute("DELETE FROM bkndbydips2.EmlpoyeeProfile");
